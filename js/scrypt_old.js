...
class Pawn {
    constructor(name, hp, exp, attackPoints, image, imageFlip, row, col,speed){
        ...
        this.takeDamage = {timeCounter:0, animTime:100, frame:0, frames: getFrames(9,[1,2,3,4],48)},
        this.takeDamageFlip = {timeCounter:0, animTime:100, frame:0, frames: getFrames(9,[4,3,2,1],48)},
    ...
    for(let i = 0; i < worldHeight; i++){
        ...
        for(let j = 0; j < worldWidth; j++){
            ...
            if(r === 0 && g === 0 && b === 0){
                ...
                tile = tiles.slime;
                type = tileType.slime;
                slimeArray.push(new Pawn("Slime",10, 0, 3, slimeSpriteSheet,slimeSpriteSheetFlip, i,j,1));
                numberOfSlimes++;
            }else{
                tile = tiles.nullTile;
                type = tileType.wall;
